	...
	<div class="container">
		...
		<div class="section-body">
			<div class="form-group">
				<button type="button" id="btn-add-announcement" class="btn btn-primary">Add Distribution</button>
			</div>
			...
			if(validate.standard('.required-input') == 0){
				$.ajax({
	                ...
	                success:function(data) {
	                	alert("Distribution Announcement Successfully Added!");
	                	location.reload();
	                }
	            });
			}
		...
		$(document).on('click', '#btn-confirm-edit-announcement', function() {
			...
			if(validate.standard('.required-input') == 0){
				$.ajax({
	                ...
	                success:function(data) {
	                	alert("Distribution Announcement Successfully Updated!");
	                	location.reload();
	                }
	            });
			}
