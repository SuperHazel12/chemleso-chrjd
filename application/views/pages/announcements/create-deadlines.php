	...
	<div class="container">
		...
		<div class="section-body">
			<div class="form-group">
				<button type="button" id="btn-add-announcement" class="btn btn-primary">Add Deadline</button>
			</div>
			<div class="table-responsive">
			<table id="table-deadline" class="table table-hover dt-responsive" cellspacing="0" width="100%">
				<thead>
					<tr>
...
<script>
	...
	$(document).ready(function() {
			announcements = $("#table-deadline").DataTable({
				ajax: {
			...
			if(validate.standard('.required-input') == 0){
				$.ajax({
	                ...
	                success:function(data) {
	                	alert("Deadline Announcement Successfully Added!");
	                	location.reload();
	                }
	            });
			}
		...
		$(document).on('click', '#btn-confirm-edit-announcement', function() {
			...
			if(validate.standard('.required-input') == 0){
				$.ajax({
	                ...
	                success:function(data) {
	                	alert("Deadline Announcement Successfully Updated!");
	                	location.reload();
	                }
	            });
			}
